# KarāraOS Dashboard Guide

## Overview
The KarāraOS Dashboard is your command center for monitoring rental operations, financial performance, and fleet health at a glance. This guide explains each metric, card, and visualization available on the dashboard.
