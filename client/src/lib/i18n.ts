...
const resources = {
  en: {
    translation: {
      ...
      "persons.addPerson": "Add Person",
      "persons.newPerson": "New Person",
      "persons.editPerson": "Edit Person",
      "persons.viewPerson": "View Person",
      "persons.disablePerson": "Disable Person",
      "persons.enablePerson": "Enable Person",
      "persons.nameEn": "Name (English)",
      "persons.nameAr": "Name (Arabic)",
      "persons.name": "Name",
      "persons.nationality": "Nationality",
      "persons.passportId": "Passport ID",
      "persons.licenseNumber": "License Number",
      "persons.mobile": "Mobile",
      "persons.address": "Address",
      "persons.relation": "Relation",
      "persons.createdBy": "Created By",
      "persons.createdAt": "Created At",
      "persons.personCreated": "Person created successfully",
      "persons.personUpdated": "Person updated successfully",
      "persons.personDisabled": "Person disabled successfully",
      "persons.personEnabled": "Person enabled successfully",
      "persons.confirmDisablePerson": "Are you sure you want to disable this person?",
      "persons.confirmEnablePerson": "Are you sure you want to enable this person?",
      "persons.searchPlaceholder": "Search by name, passport, or mobile...",
      "persons.activePersons": "Active",
      "persons.disabledPersons": "Disabled",
      "persons.disabledBy": "Disabled By",
      "persons.disabledAt": "Disabled At",
      "persons.noPersons": "No persons found",
      "persons.details": "Person Details",
      "persons.actions": "Actions",
      "persons.selectPerson": "Select person...",
      "persons.relationPlaceholder": "e.g., Employer, Family Member",
  ...
  ar: {
    translation: {
      ...
      "persons.addPerson": "إضافة شخص",
      "persons.newPerson": "شخص جديد",
      "persons.editPerson": "تعديل الشخص",
      "persons.viewPerson": "عرض الشخص",
      "persons.disablePerson": "تعطيل الشخص",
      "persons.enablePerson": "تفعيل الشخص",
      "persons.nameEn": "الاسم (إنجليزي)",
      "persons.nameAr": "الاسم (عربي)",
      "persons.name": "الاسم",
      "persons.nationality": "الجنسية",
      "persons.passportId": "رقم الجواز",
      "persons.licenseNumber": "رقم الرخصة",
      "persons.mobile": "الجوال",
      "persons.address": "العنوان",
      "persons.relation": "الصلة",
      "persons.createdBy": "أنشئ بواسطة",
      "persons.createdAt": "تاريخ الإنشاء",
      "persons.personCreated": "تم إنشاء الشخص بنجاح",
      "persons.personUpdated": "تم تحديث الشخص بنجاح",
      "persons.personDisabled": "تم تعطيل الشخص بنجاح",
      "persons.personEnabled": "تم تفعيل الشخص بنجاح",
      "persons.confirmDisablePerson": "هل أنت متأكد أنك تريد تعطيل هذا الشخص؟",
      "persons.confirmEnablePerson": "هل أنت متأكد أنك تريد تفعيل هذا الشخص؟",
      "persons.searchPlaceholder": "ابحث بالاسم أو الجواز أو الجوال...",
      "persons.activePersons": "نشط",
      "persons.disabledPersons": "معطل",
      "persons.disabledBy": "تم التعطيل بواسطة",
      "persons.disabledAt": "تاريخ التعطيل",
      "persons.noPersons": "لا يوجد أشخاص",
      "persons.details": "تفاصيل الشخص",
      "persons.actions": "الإجراءات",
      "persons.selectPerson": "اختر شخص...",
      "persons.relationPlaceholder": "مثلاً: صاحب عمل، فرد من العائلة",
