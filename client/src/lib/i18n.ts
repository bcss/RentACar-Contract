...
const resources = {
  en: {
    translation: {
      ...
      "users.cannotDeleteSuperAdmin": "Cannot delete super admin",
  ...
  ar: {
    translation: {
      ...
      "users.cannotDeleteSuperAdmin": "لا يمكن حذف المسؤول الرئيسي",
      "users.userCreated": "تم إنشاء المستخدم بنجاح",
      "users.userUpdated": "تم تحديث المستخدم بنجاح",
      "users.userDeleted": "تم حذف المستخدم بنجاح",
      "users.confirmDeleteUser": "هل أنت متأكد أنك تريد حذف هذا المستخدم؟",
