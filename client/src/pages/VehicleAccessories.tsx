      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold" data-testid="text-page-title">
            {t("nav.vehicleAccessories", "Vehicle Accessories")}
          </h1>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="catalog" className="space-y-6">
          <div className="flex justify-end">
            <Button onClick={handleCreateAccessory} className="gap-2" data-testid="button-create-accessory">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <MaterialSymbol name="inventory_2" size="md" className="text-primary" />
                Accessory Catalog
              </CardTitle>
            </CardHeader>
            <CardContent>
              {accessoriesLoading ? (
                ...
                <div className="p-12 text-center">
                  <MaterialSymbol name="inventory_2" size="2xl" className="text-muted-foreground/50 mb-4" />
        ...
        <TabsContent value="contracts" className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <Button onClick={handleCreateContractAccessory} className="gap-2" data-testid="button-create-contract-accessory">
              <MaterialSymbol name="add_circle" size="sm" />
              Assign Accessory
            </Button>
          </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <MaterialSymbol name="link" size="md" className="text-primary" />
            ...
            <CardContent>
              {contractAccessoriesLoading ? (
                ...
                <div className="p-12 text-center">
                  <MaterialSymbol name="link" size="2xl" className="text-muted-foreground/50 mb-4" />
                  <p className="text-muted-foreground">No contract accessories found</p>
                </div>
              ) : (
                <Table>
                  <TableHeader>
