  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={handleCreate} className="gap-2" data-testid="button-create-risk-score">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
                    ...
                    <MaterialSymbol name="shield" size="sm" className="text-muted-foreground" />
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
                    ...
                    <MaterialSymbol name="gavel" size="sm" className="text-muted-foreground" />
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
                    ...
                    <MaterialSymbol name="car_crash" size="sm" className="text-muted-foreground" />
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
                    ...
                    <MaterialSymbol name="traffic" size="sm" className="text-muted-foreground" />
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
                    ...
                    <MaterialSymbol name="badge" size="sm" className="text-muted-foreground" />
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
                    ...
                    <MaterialSymbol name="verified_user" size="sm" className="text-muted-foreground" />
                  </CardHeader>
                  <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <MaterialSymbol name="security" size="md" className="text-primary" />
            All Risk Scores
          </CardTitle>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <div className="p-12 text-center">
              <MaterialSymbol name="security" size="2xl" className="text-muted-foreground/50 mb-4" />
