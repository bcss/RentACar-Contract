  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        <div className="mb-6" data-testid="header-privacy-policy">
          <h1 className="text-3xl font-bold" data-testid="text-page-title">{t('legal.privacyPolicy', 'Privacy Policy')}</h1>
